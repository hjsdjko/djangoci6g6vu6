...
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px 0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231111/6dd5b058a7d54101b882572ff4a4142a.png) no-repeat center top / cover","display":"block","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#333","display":"block","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#e7e8f8","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('yonghu','首页总数')">
			...
			<div :style='{"margin":"0","alignItems":"center","textAlign":"left","flexDirection":"column-reverse","background":"none","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#ed5564","width":"auto","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"0px 0","color":"#98a6ad","top":"20px","left":"0","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"13px","position":"absolute","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 1% 12px 0","borderColor":"#e7f8f8","alignItems":"flex-end","textAlign":"center","display":"flex","float":"left","justifyContent":"center","minHeight":"168px","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"19%","position":"relative","borderStyle":"solid"}' v-if="isAuth('jnjd','首页总数')">
			...
			<div :style='{"margin":"0","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"block","width":"auto","justifyContent":"center"}'>
				<div :style='{"padding":"0 10px","margin":"0 auto","color":"#fff","borderRadius":"30px","textAlign":"center","background":"#7dc855","lineHeight":"26px","fontSize":"14px","minWidth":"80px","height":"auto"}'>{{jnjdCount}}</div>
				<div :style='{"margin":"0","color":"#98a6ad","top":"20px","textAlign":"center","left":"0","width":"100%","lineHeight":"24px","fontSize":"14px","position":"absolute","height":"24px"}'>济南酒店总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
