		...
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jnjdChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="jnjdChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							...
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{yonghuCount}}</div>
						</div>
					</div>

					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"yellow","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>济南酒店总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{jnjdCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>济南酒店</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="name" label="酒店名"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="starlevel" label="星级"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="score" label="评分"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="tags" label="评价标签"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="commentcount" label="点评数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="price" label="价格"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="comment" label="评价"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jnjdChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jnjdChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="jnjdChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'jnjdChart1');
...
//统计接口2
    jnjdChat2() {
      this.$nextTick(()=>{
        ...
        var jnjdChart2 = echarts.init(document.getElementById("jnjdChart2"),'macarons');
        this.$http({
...
//统计接口3
    jnjdChat3() {
      this.$nextTick(()=>{
        ...
        var jnjdChart3 = echarts.init(document.getElementById("jnjdChart3"),'macarons');
        this.$http({
            url: "jnjd/group/tags",
            method: "get",
        }).then(({ data }) => {
...
//统计接口4
    jnjdChat4() {
      this.$nextTick(()=>{
        ...
        var jnjdChart4 = echarts.init(document.getElementById("jnjdChart4"),'macarons');
        this.$http({
...
//统计接口5
    jnjdChat5() {
      this.$nextTick(()=>{
        ...
        var jnjdChart5 = echarts.init(document.getElementById("jnjdChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                jnjdChart5.setOption(option);

				this.myChartInterval(1, option.xAxis.data, option.series[0].data, jnjdChart5)
