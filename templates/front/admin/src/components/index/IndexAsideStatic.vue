...
export default {
	data() {
		return {
			...
			verticalFlag: false,
			isCollapse: false,
			verticalStyle2: {"isCollapse":false,"close":{"contentBox":{"hover":{},"active":{"margin":"0 0 0 54px"},"default":{"minHeight":"100%","padding":"70px 0 0 40px","margin":"0","position":"relative","background":"#f4f8fb","display":"block"}},"box":{"hover":{},"active":{"width":"54px"},"default":{"boxShadow":"0px 0 0px rgba(255,205,155,1)","padding":"0px 0 0","borderColor":"rgba(126, 96, 16, .2)","color":"#fff","bottom":"0","transition":"all 0s","overflow":"hidden","top":"0","left":"0","background":"#4285f4","borderWidth":"0 0px 0 0","width":"40px","fontSize":"0px","position":"fixed","borderStyle":"solid","height":"100%","zIndex":"1001"}},"menu":{"two":{"title":{"hover":{"border":"0px solid #fbbe62","padding":"0 0px","color":"#fff","textAlign":"center","background":"#3b76da!important","lineHeight":"40px","height":"40px"},"active":{"border":"0px solid #fbbe62","padding":"0 0px","color":"#fff","textAlign":"center","background":"#3b76da!important","lineHeight":"40px","height":"40px"},"default":{"border":"0px solid #fbbe62","padding":"0 0px","backgroundColor":"#4285f4","color":"#fff","textAlign":"center","lineHeight":"40px","fontSize":"14px","height":"40px"}},"box":{"hover":{},"default":{"border":"none","padding":"0","margin":"0","borderRadius":"0"}}},"box":{"hover":{},"default":{"border":0,"padding":"0 0px","listStyle":"none","margin":"0","flexWrap":"wrap","background":"none","display":"flex","position":"relative"}},"one":{"box1":{"hover":{"color":"#fff","background":"#3b76da"},"active":{"color":"#fff","background":"#3b76da"},"default":{"cursor":"pointer","padding":"0 8px","whiteSpace":"nowrap","color":"#fff","background":"none","fontSize":"inherit","position":"relative"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0","color":"inherit","textAlign":"center","display":"inline-block","width":"24px","fontSize":"24px"},"flag":true},"box":{"hover":{},"default":{"width":"auto","padding":"0","listStyle":"none","margin":"0","fontSize":"inherit"}},"title":{"hover":{},"default":{"width":"0","verticalAlign":"middle","fontSize":"inherit","color":"inherit","height":"0"}},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","display":"none","fontSize":"12px","position":"absolute","right":"60px"}}}},"btn":{"icon":{"hover":{},"default":{"margin":"0","fontSize":"30px","color":"#03a9f4","display":"none"},"text":"icon-menu08"},"hover":{"opacity":"0.8"},"default":{"border":"0","cursor":"pointer","padding":"0px","margin":"0","color":"#fff","outline":"none","borderRadius":"0px","top":"26px","left":"52px","background":"url(http://codegen.caihongy.cn/20231103/e311563cd06a480e901ea7102c6178bd.png) no-repeat center top","width":"25px","fontSize":"14px","position":"fixed","height":"16px","zIndex":"1003"},"text":""},"user":{"two":{"title":{"hover":{"padding":"0 0px","backgroundColor":"#3b76da!important","lineHeight":"40px","color":"#fff","height":"40px"},"active":{"padding":"0 0px","backgroundColor":"#3b76da!important","lineHeight":"40px","color":"#fff","height":"40px"},"default":{"padding":"0 0px","backgroundColor":"#4285f4","lineHeight":"40px","fontSize":"14px","color":"#fff","height":"40px"}},"box":{"hover":{},"default":{"border":"none"}}},"one":{"box1":{"hover":{"color":"#c1d2e2","background":"#3b76da"},"active":{"color":"#c1d2e2","background":"#3b76da"},"default":{"cursor":"pointer","padding":"0 8px","whiteSpace":"nowrap","position":"relative","color":"#fff","background":"none"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0","color":"inherit","textAlign":"center","display":"inline-block","width":"24px","fontSize":"24px"},"flag":true,"text":"icon-kuaijiezhifu"},"box":{"hover":{},"default":{"padding":"0","listStyle":"none","margin":"0","display":"block","order":"2"}},"title":{"hover":{},"default":{"width":"0","verticalAlign":"middle","fontSize":"inherit","color":"inherit","height":"0"}},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","display":"none","fontSize":"12px","position":"absolute","right":"60px"}}}},"userinfo":{"nickname":{"hover":{},"default":{"fontSize":"24px","lineHeight":"1.5","color":"#fff","textAlign":"center"}},"img":{"hover":{},"default":{"width":"100%","objectFit":"cover","borderRadius":"20px","display":"block","height":"170px"}},"box":{"hover":{},"default":{"width":"100%","padding":"20px","display":"none","height":"auto"}}},"home":{"two":{"title":{"hover":{"padding":"0 20px","backgroundColor":"#1c2324!important","lineHeight":"56px","color":"#fff","height":"56px"},"active":{"padding":"0 20px","backgroundColor":"#1c2324!important","lineHeight":"56px","color":"#fff","height":"56px"},"default":{"padding":"0 20px","backgroundColor":"#1c2324","lineHeight":"56px","color":"#999","height":"56px"}},"box":{"hover":{},"default":{"border":"none"}}},"one":{"box1":{"hover":{"color":"#fff","background":"#3b76da"},"active":{"color":"#fff","background":"#3b76da"},"default":{"cursor":"pointer","padding":"0 8px","whiteSpace":"nowrap","color":"#fff","background":"none","width":"100%","fontSize":"inherit","position":"relative"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0","color":"inherit","textAlign":"center","display":"inline-block","width":"24px","fontSize":"24px"},"flag":true,"text":"icon-home7"},"box":{"hover":{},"default":{"width":"100%","padding":"0","listStyle":"none","margin":"0","color":"#999","display":"block"}},"title":{"hover":{},"default":{"width":"0","verticalAlign":"middle","fontSize":"inherit","color":"inherit","height":"0"}},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","display":"none","fontSize":"12px","position":"absolute","right":"20px"}}}}},"open":{"contentBox":{"hover":{},"default":{"minHeight":"100%","padding":"70px 0 0 270px","margin":"0","position":"relative","background":"#f4f8fb","display":"block"}},"box":{"hover":{},"default":{"padding":"0px 0px 0","borderColor":"#ddd","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"0","left":"0","background":"url(http://codegen.caihongy.cn/20231111/f85c08c4a5004bc4bacf8177e333b366.png) no-repeat right top,url(http://codegen.caihongy.cn/20231111/6dd5b058a7d54101b882572ff4a4142a.png) repeat-y right top,#4285f4","borderWidth":"0","width":"270px","fontSize":"16px","position":"fixed","borderStyle":"solid","height":"100%","zIndex":"1003"}},"menu":{"two":{"title":{"hover":{"padding":"0 0 0 95px","boxShadow":"0px 0px 0px 0px #fff","color":"#fff","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"94%","lineHeight":"40px","height":"auto"},"active":{"padding":"0 0 0 95px","boxShadow":"0px 0px 0px 0px #fff","color":"#fff","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"94%","lineHeight":"40px","height":"auto"},"default":{"padding":"0 0 0 95px","margin":"0px 0 0","borderColor":"rgba(126, 96, 16, .2)","color":"#fff","textAlign":"left","transition":"all 0s","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center","borderWidth":"0 0 0px","width":"calc(100% - 40px)","lineHeight":"40px","fontSize":"14px","borderStyle":"dashed","height":"auto"}},"box":{"hover":{},"default":{"padding":"0px","margin":"0px","borderColor":"#ddd","borderRadius":"0px","background":"none","borderWidth":"0px 0","width":"100%","fontSize":"inherit","borderStyle":"solid"}}},"box":{"hover":{},"default":{"border":0,"padding":"100px 0px 60px","boxShadow":"0 2px 5px 0 rgba(239, 235, 235, 0.16), 0 2px 10px 0 rgba(72, 70, 70, 0.12)","margin":"0","alignItems":"flex-start","flexDirection":"column","display":"flex","minHeight":"100vh","listStyle":"none","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231102/1eca7b20338c47b6b5a696c59dba8184.png) no-repeat 20px 16px,url(http://codegen.caihongy.cn/20231102/435c4f4a7c35495c8b7174c16a3a26ff.png) no-repeat 16px 70px","position":"relative","height":"100%"}},"one":{"box1":{"hover":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid","height":"auto"},"active":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid","height":"auto"},"default":{"cursor":"pointer","padding":"0px 25px 0px 60px","borderColor":"#fff","margin":"0 0 10px","whiteSpace":"nowrap","color":"#fff","transition":"all 0.3s","borderRadius":"0px","background":"#4285f4","borderWidth":"0 0 0 0px","width":"calc(100% - 40px)","fontSize":"inherit","lineHeight":"44px","position":"relative","borderStyle":"solid","height":"auto"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","display":"inline-block","width":"auto","fontSize":"16px"},"flag":true},"box":{"hover":{},"default":{"width":"100%","padding":"0px","listStyle":"none","margin":"0","lineHeight":"auto","height":"auto"}},"title":{"hover":{},"default":{"verticalAlign":"middle","color":"inherit","textAlign":"center","display":"inline-block","width":"auto","fontSize":"inherit","lineHeight":"auto"}},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","fontSize":"inherit","position":"absolute","right":"20px"}}}},"btn":{"icon":{"hover":{},"default":{"margin":"0px 2px","fontSize":"30px","color":"#03a9f4","display":"none"},"text":"icon-menu08"},"hover":{"opacity":"0.8"},"default":{"border":"0px solid #ddd","cursor":"pointer","padding":"0px","margin":"0","color":"#fff","display":"block","outline":"none","borderRadius":"0px","top":"26px","left":"245px","background":"url(http://codegen.caihongy.cn/20231103/e311563cd06a480e901ea7102c6178bd.png) no-repeat center top","width":"25px","fontSize":"inherit","position":"fixed","height":"16px","zIndex":"1003"},"text":""},"user":{"two":{"title":{"hover":{"padding":"0 0 0 95px","boxShadow":"0px 0px 0px 0px #fff","color":"#fff","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"94%","lineHeight":"40px","height":"auto"},"active":{"padding":"0 0 0 95px","boxShadow":"0px 0px 0px 0px #fff","color":"#fff","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"94%","lineHeight":"40px","height":"auto"},"default":{"padding":"0 0 0 95px","borderColor":"rgba(126, 96, 16, .2)","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center","borderWidth":"0 0 0px","width":"calc(100% - 40px)","lineHeight":"40px","fontSize":"14px","borderStyle":"dashed","transition":"all 0s","height":"auto"}},"box":{"hover":{},"default":{"padding":"0 0 0 0px","margin":"0px","borderColor":"#ddd","borderRadius":"0px","background":"none","borderWidth":"0px 0","width":"100%","fontSize":"inherit","borderStyle":"solid"}}},"one":{"box1":{"hover":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid","height":"auto"},"active":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid","height":"auto"},"default":{"cursor":"pointer","padding":"0px 25px 0px 60px","borderColor":"#fff","whiteSpace":"nowrap","color":"#fff","transition":"all 0.3s","borderRadius":"0px","background":"#4285f4","borderWidth":"0 0 0 0px","width":"calc(100% - 40px)","fontSize":"inherit","lineHeight":"44px","position":"relative","borderStyle":"solid","height":"auto"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","display":"inline-block","width":"auto","fontSize":"16px"},"flag":true,"text":"icon-touxiang15"},"box":{"hover":{},"default":{"padding":"0px","listStyle":"none","margin":"0","display":"block","width":"100%","lineHeight":"auto","order":"2","height":"auto"}},"title":{"hover":{},"default":{"verticalAlign":"middle","color":"inherit","textAlign":"center","display":"inline-block","width":"auto","fontSize":"inherit","lineHeight":"auto"},"text":"用户资料"},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","fontSize":"inherit","position":"absolute","right":"20px"}}}},"userinfo":{"nickname":{"hover":{},"default":{"padding":"0","margin":"16px 0 0","color":"#9ca5ac","textAlign":"center","background":"none","display":"inline-block","fontSize":"16px","lineHeight":"1","minWidth":"130px","fontWeight":"600","maxWidth":"132px"}},"img":{"hover":{},"default":{"margin":"0 auto","outline":"1px solid #ddd","objectFit":"cover","borderRadius":"100%","outlineOffset":"4px","background":"#fff","display":"block","width":"76px","height":"76px"}},"box":{"hover":{},"default":{"padding":"0 0 0px","margin":"26px auto 52px","flexWrap":"wrap","textAlign":"center","display":"none","width":"100%","height":"auto","order":"2"}}},"home":{"two":{"title":{"hover":{"padding":"0 40px","lineHeight":"50px","color":"#fff","background":"#001528","height":"50px"},"active":{"padding":"0 40px","lineHeight":"50px","color":"#fff","background":"#001528","height":"50px"},"default":{"padding":"0 40px","lineHeight":"50px","color":"#664","background":"#1f2d3d","height":"50px"}},"box":{"hover":{},"default":{"border":"none","display":"none"}}},"one":{"box1":{"hover":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid"},"active":{"borderColor":"#71b6f9","color":"#fff","borderRadius":"0px","background":"#3b76da","borderWidth":"0 0 0 0px","clipPath":"polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%)","width":"98%","borderStyle":"solid"},"default":{"cursor":"pointer","padding":"0px 25px 0px 60px","borderColor":"#fff","margin":"0 0 10px","whiteSpace":"nowrap","color":"#fff","transition":"all 0.3s","borderRadius":"0px","background":"#4285f4","borderWidth":"0 0 0 0px","width":"calc(100% - 40px)","fontSize":"inherit","lineHeight":"44px","position":"relative","borderStyle":"solid","height":"auto"}},"icon":{"hover":{},"default":{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","display":"inline-block","width":"auto","fontSize":"16px"},"flag":true,"text":"icon-xiugai19"},"box":{"hover":{},"default":{"padding":"0px","listStyle":"none","margin":"0","display":"block","width":"100%","fontSize":"inherit","lineHeight":"auto","height":"auto"}},"title":{"hover":{},"default":{"color":"inherit","verticalAlign":"middle","fontSize":"inherit"},"text":"Dashboard"},"arrow":{"hover":{},"default":{"verticalAlign":"middle","margin":"-7px 0 0 0","top":"50%","color":"inherit","fontSize":"12px","position":"absolute","right":"20px"}}}}}},
...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
				...
				clip-path: polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%) !important;
				color: #fff !important;
				background: #3b76da !important;
				width: 98% !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
				...
				border-radius: 0px !important;
				background: url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center !important;
				width: calc(100% - 40px) !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
				...
				clip-path: polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%) !important;
				color: #fff !important;
				background: url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da !important;
				width: 94% !important;
				line-height: 40px !important;
				height: auto !important;
			}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.home>.el-tooltip:hover {
				border-radius: 0px;
				clip-path: polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%);
				color: #fff;
				background: #3b76da;
				width: 98%;
				border-color: #71b6f9;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
				...
				transition: all 0s;
				border-radius: 0px;
				background: url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center;
				width: calc(100% - 40px);
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
				...
				clip-path: polygon(93% 1%, 100% 50%, 93% 100%, 0% 100%, 0% 0%);
				color: #fff;
				background: url(http://codegen.caihongy.cn/20231102/77b5e1e4fb30486a84fe7007aa1ea3ac.png) no-repeat 75px center,#3b76da;
				width: 94%;
				line-height: 40px;
				height: auto;
			}
