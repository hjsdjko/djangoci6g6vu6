...
class jnjd(BaseModel):
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    name=models.CharField ( max_length=255, null=True, unique=False, verbose_name='酒店名' )
    picture=models.TextField   (  null=True, unique=False, verbose_name='图片' )
    starlevel=models.FloatField   (  null=True, unique=False, verbose_name='星级' )
    score=models.FloatField   (  null=True, unique=False, verbose_name='评分' )
    tags=models.CharField ( max_length=255, null=True, unique=False, verbose_name='评价标签' )
    commentcount=models.IntegerField  (  null=True, unique=False, verbose_name='点评数' )
    price=models.FloatField   (  null=True, unique=False, verbose_name='价格' )
    comment=models.CharField ( max_length=255, null=True, unique=False, verbose_name='评价' )
    address=models.CharField ( max_length=255, null=True, unique=False, verbose_name='地址' )
    laiyuan=models.TextField   (  null=True, unique=False, verbose_name='来源' )
    ...
    class Meta:
        db_table = 'jnjd'
        verbose_name = verbose_name_plural = '济南酒店'
...
class discussjnjd(BaseModel):
    __doc__ = u'''discussjnjd'''
    __tablename__ = 'discussjnjd'
    ...
    '''
    class Meta:
        db_table = 'discussjnjd'
        verbose_name = verbose_name_plural = 'jnjd评论表'
