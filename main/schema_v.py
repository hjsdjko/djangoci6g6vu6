...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spiderq7e0dz8b && scrapy crawl "+tableName+"Spider -a databaseName=djangoci6g6vu6"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangoci6g6vu6"
        os.system(cmd)
