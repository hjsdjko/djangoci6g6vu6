...
#批量生成数据
        ...
        if tableName.lower() == "jnjd":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/price'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_price".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "jnjd":
            urlpatterns.extend(
        ...
        if tableName.lower() == "discussjnjd":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
